    ...
    <Row>
      <Col md={3}>
        ...
        <Form onSubmit={submitHandler}>
          ...
          <Form.Group controlId="email" className="mt-2 mb-1">
          ...
          <Form.Group controlId="password" className="mt-2 mb-1">
          ...
          <Form.Group controlId="confirmPassword" className="mt-2 mb-1">
